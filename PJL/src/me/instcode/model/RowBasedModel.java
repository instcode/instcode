...
public abstract class RowBasedModel<T> implements ModifyTrackerAwareness {
	...
	protected void fireRowsRemoved(Object data) {
		RowDataChangeEvent event = new RowDataChangeEvent(this, data, RowDataChangeEvent.ROWS_REMOVED_CHANGE);
		fireRowDataChanged(event);
	}
